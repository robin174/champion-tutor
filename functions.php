<?php
/**
* Champion Tutor functions and definitions
...
function championtutor_scripts() {

    // load Bootstrap CSS v5.1
    wp_enqueue_style( 'championtutor-bootstrap-css', THEME_DIR_URI . '/includes/css/bootstrap.min.css');

    // load website CSS, versioned
    wp_enqueue_style( 'championtutor-css', THEME_DIR_URI . '/assets/css/style.css', [], filemtime( get_stylesheet_directory() . '/assets/css/style.css') );

	// load Bootstrap JS v5.1
	wp_enqueue_script( 'championtutor-bootstrap-js', THEME_DIR_URI . '/includes/js/bootstrap.min.js', array('jquery') );
}
add_action( 'wp_enqueue_scripts', 'championtutor_scripts' );
...
/* Register menus */
if ( ! function_exists( 'championtutor_setup' ) ) :
	function championtutor_setup() {

    register_nav_menus( array(
        'primary' => __( 'Primary Menu', 'championtutor' ),
        'footer'  => __( 'Footer Menu', 'championtutor' ),
    ) );
...
add_action( 'after_setup_theme', 'championtutor_setup');
